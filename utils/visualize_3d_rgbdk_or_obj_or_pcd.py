...
# example usage: python3 utils/visualize_3d_rgbdk_or_obj_or_pcd.py ./demo_rgbdk/mug_lots_of_occlusion.npy ./demo_out/mug_lots_of_occlusion_0.obj
...
def visualize(file_paths, eef_pose=None, in_world_frame=False):
    ...
    if not in_world_frame:
        ...
        CAMERA_CALIBRATION_FILE = os.path.expanduser(
            '~/robot-grasp/data/camera_calibration/camera2robot.npz')
...
if __name__ == '__main__':
    ...
    parser.add_argument('file_paths', nargs='+',
                        help='Paths to the RGB-D + K (camera matrix) data files')
